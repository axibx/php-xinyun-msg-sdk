...
namespace Com\Weimob\Cloud\Msg\Promote;
...
class AddCustomerMessage implements \JsonSerializable
{
    ...
    */
    public function setCustomerWid(?int $customerWid)
    {
    ...
    */
    public function setLastActiveTime(?int $lastActiveTime)
    {
    ...
    * @param string $wxId
    */
    public function setWxId(?string $wxId)
    {
        $this->wxId = $wxId;
    }
    ...
    */
    public function setFollowStage(?string $followStage)
    {
    ...
    */
    public function setTurnoverRate(?int $turnoverRate)
    {
    ...
    */
    public function setEmployeeWid(?int $employeeWid)
    {
    ...
    */
    public function setFirstContactTime(?int $firstContactTime)
    {
