 ...
 * @create 2022年11月16日
 */
interface EcRightsAgreeRightsListener
{
    const topic = 'ec_rights';
    const event = 'agreeRights';
    const classType = AgreeRightsMessage::class;
    const specType = 'xinyun';

    public function onMessage(WeimobMessage $message) : WeimobMessageAck;
}

class AgreeRightsMessage implements \JsonSerializable
{
    /**
    * 售后单编号
    * @var int
