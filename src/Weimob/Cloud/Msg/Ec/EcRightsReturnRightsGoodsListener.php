 ...
 * @create 2022年11月16日
 */
interface EcRightsReturnRightsGoodsListener
{
    const topic = 'ec_rights';
    const event = 'returnRightsGoods';
    const classType = ReturnRightsGoodsMessage::class;
    const specType = 'xinyun';

    public function onMessage(WeimobMessage $message) : WeimobMessageAck;
}

class ReturnRightsGoodsMessage implements \JsonSerializable
{
    /**
    * 售后单编号
    * @var int
