 ...
 * @create 2022年11月16日
 */
interface EcOrderOrderUpdateListener
{
    const topic = 'ec_order';
    const event = 'orderUpdate';
    const classType = OrderUpdateMessage::class;
    const specType = 'xinyun';

    public function onMessage(WeimobMessage $message) : WeimobMessageAck;
}

class OrderUpdateMessage implements \JsonSerializable
{
    /**
    * 订单编号
    * @var int
    */
    ...
    /**
    * 操作类型：101=更新标记，102=更新收货地址
    * @var int
    */
    private $operateType;

    /**
    * 标记等级：1红，2黄，3绿，4浅蓝，5深蓝（仅operateType=101的时候有值）
    * @var int
    */
    private $flagRank;

    /**
    * 标记内容（仅operateType=101的时候有值）
    * @var string
    */
    private $flagContent;
