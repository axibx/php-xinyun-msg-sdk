 ...
 * @create 2022年11月16日
 */
interface EcRightsCancelRightsListener
{
    const topic = 'ec_rights';
    const event = 'cancelRights';
    const classType = CancelRightsMessage::class;
    const specType = 'xinyun';

    public function onMessage(WeimobMessage $message) : WeimobMessageAck;
}

class CancelRightsMessage implements \JsonSerializable
{
    /**
    * 维权编号
    * @var int
